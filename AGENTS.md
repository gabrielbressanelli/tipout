...
- Brand assets live in `tips/static/tips/brand/`; header/signup pages use `logo-final.png`, login uses `logo-login.png`, and favicon links use the generated favicon package.
